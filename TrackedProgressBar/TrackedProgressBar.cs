...
namespace TrackedProgressBar {
	...
	public partial class TrackedProgressBar : UserControl {
		...
		*/
		...
		/// <summary>
		/// On what side to draw the tracks.
		/// </summary>
		...
		public int Maximum {
			...
			set {
				...
				} else throw new ArgumentOutOfRangeException(paramName: "Maximum", actualValue: value, message: "The new value must be higher than the Minimum property (" + _Minimum.ToString() + ")");
			}
		}
